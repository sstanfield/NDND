...
namespace ahnd {
    ...
    private:
        ...
        void registerRoute(const ndn::Name &route_name, int face_id,
        ...
        void onRegisterRouteDataReply(const ndn::Interest &interest, const ndn::Data &data,
                                      const ndn::Name &route_name, int face_id,
                                      int cost, const bool send_data);
        void onAddFaceDataReply(const ndn::Interest &interest, const ndn::Data &data,
                                const std::string &uri, const ndn::Name prefix, DBEntry entry,
                                const bool send_data);
        void onDestroyFaceDataReply(const ndn::Interest &interest, const ndn::Data &data);
        void addFaceAndPrefix(const std::string &uri, const ndn::Name prefix, DBEntry entry, const bool send_data);
        void destroyFace(int face_id);
        void onSetStrategyDataReply(const ndn::Interest &interest, const ndn::Data &data);
